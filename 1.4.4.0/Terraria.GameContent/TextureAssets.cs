...
namespace Terraria.GameContent
{
	public static class TextureAssets
	{
		...
		public static Asset<Texture2D>[] NpcHead = new Asset<Texture2D>[81];
		...
		public static Asset<Texture2D>[] ArmorHead = new Asset<Texture2D>[282];

		public static Asset<Texture2D>[] ArmorBody = new Asset<Texture2D>[248];

		public static Asset<Texture2D>[] ArmorBodyComposite = new Asset<Texture2D>[248];

		public static Asset<Texture2D>[] FemaleBody = new Asset<Texture2D>[248];

		public static Asset<Texture2D>[] ArmorArm = new Asset<Texture2D>[248];

		public static Asset<Texture2D>[] ArmorLeg = new Asset<Texture2D>[236];

		public static Asset<Texture2D>[] AccHandsOn = new Asset<Texture2D>[24];

		public static Asset<Texture2D>[] AccHandsOnComposite = new Asset<Texture2D>[24];

		public static Asset<Texture2D>[] AccHandsOff = new Asset<Texture2D>[16];

		public static Asset<Texture2D>[] AccHandsOffComposite = new Asset<Texture2D>[16];

		public static Asset<Texture2D>[] AccBack = new Asset<Texture2D>[37];

		public static Asset<Texture2D>[] AccFront = new Asset<Texture2D>[13];
		...
		public static Asset<Texture2D>[] AccFace = new Asset<Texture2D>[22];

		public static Asset<Texture2D>[] AccBalloon = new Asset<Texture2D>[20];
		...
		public static Asset<Texture2D>[] Buff = new Asset<Texture2D>[355];

		public static Asset<Texture2D>[] Item = new Asset<Texture2D>[5453];

		public static Asset<Texture2D>[] ItemFlame = new Asset<Texture2D>[5453];

		public static Asset<Texture2D>[] Npc = new Asset<Texture2D>[688];

		public static Asset<Texture2D>[] Projectile = new Asset<Texture2D>[1022];

		public static Asset<Texture2D>[] Gore = new Asset<Texture2D>[1383];

		public static Asset<Texture2D>[] BackPack = new Asset<Texture2D>[10];

		public static Asset<Texture2D> Rain;

		public static Asset<Texture2D>[] GlowMask = new Asset<Texture2D>[353];

		public static Asset<Texture2D>[] Extra = new Asset<Texture2D>[264];

		public static Asset<Texture2D>[] HighlightMask = new Asset<Texture2D>[693];
		...
		public static Asset<Texture2D>[] Tile = new Asset<Texture2D>[693];

		public static Asset<Texture2D> BlackTile;

		public static Asset<Texture2D>[] Wall = new Asset<Texture2D>[347];
