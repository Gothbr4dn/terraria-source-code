		...
		public static void SendData(int msgType, int remoteClient = -1, int ignoreClient = -1, NetworkText text = null, int number = 0, float number2 = 0f, float number3 = 0f, float number4 = 0f, int number5 = 0, int number6 = 0, int number7 = 0)
		{
			...
			lock (buffer[num])
			{
				...
				case 4:
				{
					...
					{
						bitsByte16[num12] = player4.hideVisibleAccessory[num12 + 8];
					}
					writer.Write(bitsByte16);
					...
					bitsByte17[2] = player4.extraAccessory;
					writer.Write(bitsByte17);
					BitsByte bitsByte18 = (byte)0;
					bitsByte18[0] = player4.UsingBiomeTorches;
					bitsByte18[1] = player4.happyFunTorchTime;
					bitsByte18[2] = player4.unlockedBiomeTorches;
					bitsByte18[3] = player4.unlockedSuperCart;
					bitsByte18[4] = player4.enabledSuperCart;
					writer.Write(bitsByte18);
					BitsByte bitsByte19 = (byte)0;
					bitsByte19[0] = player4.usedAegisCrystal;
					bitsByte19[1] = player4.usedAegisFruit;
					bitsByte19[2] = player4.usedArcaneCrystal;
					bitsByte19[3] = player4.usedGalaxyPearl;
					bitsByte19[4] = player4.usedGummyWorm;
					bitsByte19[5] = player4.usedAmbrosia;
				...
				case 9:
				{
					writer.Write(number);
					text.Serialize(writer);
					BitsByte bitsByte23 = (byte)number2;
				...
				case 13:
				{
					...
					bitsByte26[0] = player7.controlUp;
					bitsByte26[1] = player7.controlDown;
					bitsByte26[2] = player7.controlLeft;
					bitsByte26[3] = player7.controlRight;
					bitsByte26[4] = player7.controlJump;
					bitsByte26[5] = player7.controlUseItem;
					bitsByte26[6] = player7.direction == 1;
					writer.Write(bitsByte26);
					BitsByte bitsByte27 = (byte)0;
					bitsByte27[0] = player7.pulley;
					bitsByte27[1] = player7.pulley && player7.pulleyDir == 2;
					bitsByte27[2] = player7.velocity != Vector2.Zero;
					bitsByte27[3] = player7.vortexStealthActive;
					bitsByte27[4] = player7.gravDir == 1f;
					bitsByte27[5] = player7.shieldRaised;
					bitsByte27[6] = player7.ghost;
					writer.Write(bitsByte27);
					BitsByte bitsByte28 = (byte)0;
					bitsByte28[0] = player7.tryKeepingHoveringUp;
					bitsByte28[1] = player7.IsVoidVaultEnabled;
					bitsByte28[2] = player7.sitting.isSitting;
					bitsByte28[3] = player7.downedDD2EventAnyDifficulty;
					bitsByte28[4] = player7.isPettingAnimal;
					bitsByte28[5] = player7.isTheAnimalBeingPetSmall;
					bitsByte28[6] = player7.PotionOfReturnOriginalUsePosition.HasValue;
					bitsByte28[7] = player7.tryKeepingHoveringDown;
					writer.Write(bitsByte28);
					BitsByte bitsByte29 = (byte)0;
					bitsByte29[0] = player7.sleeping.isSleeping;
					bitsByte29[1] = player7.autoReuseAllWeapons;
					bitsByte29[2] = player7.controlDownHold;
					bitsByte29[3] = player7.isOperatingAnotherEntity;
				...
				case 20:
				{
					...
					if (num15 >= Main.maxTilesX + num17)
					{
						num15 = Main.maxTilesX - num17 - 1;
					}
					if (num16 < num18)
					{
						num16 = num18;
					}
					if (num16 >= Main.maxTilesY + num18)
					{
						num16 = Main.maxTilesY - num18 - 1;
					}
					...
					{
						for (int num20 = num16; num20 < num16 + num18; num20++)
						{
							...
							bitsByte20[0] = tile2.active();
							bitsByte20[2] = tile2.wall > 0;
							bitsByte20[3] = tile2.liquid > 0 && Main.netMode == 2;
							bitsByte20[4] = tile2.wire();
							bitsByte20[5] = tile2.halfBrick();
							bitsByte20[6] = tile2.actuator();
							bitsByte20[7] = tile2.inActive();
							bitsByte21[0] = tile2.wire2();
							bitsByte21[1] = tile2.wire3();
							...
							bitsByte21 = (byte)((byte)bitsByte21 + (byte)(tile2.slope() << 4));
							bitsByte21[7] = tile2.wire4();
							bitsByte22[0] = tile2.fullbrightBlock();
							bitsByte22[1] = tile2.fullbrightWall();
							bitsByte22[2] = tile2.invisibleBlock();
							bitsByte22[3] = tile2.invisibleWall();
				...
				case 27:
				{
					...
					bitsByte24[0] = projectile.ai[0] != 0f;
					bitsByte24[1] = projectile.ai[1] != 0f;
					bitsByte25[0] = projectile.ai[2] != 0f;
