...
namespace Terraria.IO
{
	public class WorldFile
	{
		...
		public static WorldFileData CreateMetadata(string name, bool cloudSave, int GameMode)
		{
			...
			worldFileData.WorldGeneratorVersion = 1155346202625uL;
		...
		public static void LoadWorld(bool loadFromCloud)
		{
			...
			try
			{
				...
				try
				{
					...
					if (_versionNumber <= 0 || _versionNumber > 269)
					{
		...
		{
			writer.Write(NPC.ShimmeredTownNPCs.Count);
			foreach (int shimmeredTownNPC in NPC.ShimmeredTownNPCs)
			{
				writer.Write(shimmeredTownNPC);
			}
		...
		public static void LoadNPCs(BinaryReader reader)
		{
			if (_versionNumber >= 268)
			{
				...
				while (num-- > 0)
				{
					NPC.ShimmeredTownNPCs.Add(reader.ReadInt32());
				}
			}
			int num2 = 0;
