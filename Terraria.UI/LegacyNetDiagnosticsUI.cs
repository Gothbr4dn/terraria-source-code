...
namespace Terraria.UI
{
	public class LegacyNetDiagnosticsUI : INetDiagnosticsUI
	{
		...
		private const int maxMsg = 149;

		public static int[] rxMsgType = new int[149];

		public static int[] rxDataType = new int[149];

		public static int[] txMsgType = new int[149];

		public static int[] txDataType = new int[149];
